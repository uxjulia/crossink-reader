...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_CLOCK_FORMAT, &CrossPointSettings::clockFormat,
                        {StrId::STR_24H, StrId::STR_12H}, "clockFormat", StrId::STR_CAT_SYSTEM),
      SettingInfo::Enum(StrId::STR_TIMEZONE, &CrossPointSettings::timezoneIndex,
                        {StrId::STR_UTC_M12, StrId::STR_UTC_M11, StrId::STR_UTC_M10, StrId::STR_UTC_M9,
                         StrId::STR_UTC_M8, StrId::STR_UTC_M7, StrId::STR_UTC_M6, StrId::STR_UTC_M5,
                         StrId::STR_UTC_M4, StrId::STR_UTC_M3, StrId::STR_UTC_M2, StrId::STR_UTC_M1,
                         StrId::STR_UTC_0, StrId::STR_UTC_P1, StrId::STR_UTC_P2, StrId::STR_UTC_P3,
                         StrId::STR_UTC_P4, StrId::STR_UTC_P5, StrId::STR_UTC_P6, StrId::STR_UTC_P7,
                         StrId::STR_UTC_P8, StrId::STR_UTC_P9, StrId::STR_UTC_P10, StrId::STR_UTC_P11,
                         StrId::STR_UTC_P12, StrId::STR_UTC_P13, StrId::STR_UTC_P14},
