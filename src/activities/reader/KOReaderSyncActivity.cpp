...
void KOReaderSyncActivity::onWifiSelectionComplete(const bool success) {
  ...
  // Sync time with NTP before making API requests, then persist the timestamp
  // so the clock can be restored on the next boot without WiFi.
  TimeStore::syncAndSave();
